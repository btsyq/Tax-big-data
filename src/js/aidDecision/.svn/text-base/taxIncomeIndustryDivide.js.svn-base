...
//	            	console.log(params)
	        ...
	        series: [{
               ...
               data:[
	            { name: '济南市', value: randomData2()},
	            { name: '青岛市', value: randomData2()},
	            { name: '淄博市', value: randomData2()},
	            { name: '枣庄市', value: randomData2()},
	            { name: '东营市', value: randomData2()},
	            { name: '烟台市', value: randomData2()},
	            { name: '潍坊市', value: randomData2()},
	            { name: '济宁市', value: randomData2()},
	            { name: '泰安市', value: randomData2()},
	            { name: '威海市', value: randomData2()},
	            { name: '日照市', value: randomData2()},
	            { name: '滨州市', value: randomData2()},
	            { name: '德州市', value: randomData2()},
	            { name: '聊城市', value: randomData2()},
	            { name: '临沂市', value: randomData2()},
	            { name: '菏泽市', value: randomData2()},
	            { name: '莱芜市', value: randomData2()}
	          ]
        	}]
			...
			tooltip: {
				...
				formatter: function(params) {
					...
					return '<span style="color:#008ef2;font-weight:bold; font-size:16px">' + params[0].name + '</span>' + '<br/>' +
						'<span style="color:#666;">' + '税收收入' + ' : </span>' + '<span style="color:#ff9100;font-weight:bold;">' + params[0].value + '</span>' + '<br/>'
...
function deptType() {
	...
	var id=0;
	var nameArr=[
		['华新圣铭色织有限责任公司','兴达丝绸有限责任公司','联达机客车配件有限公司','宏旺机械设备制造有限公司','东泰焊管有限公司'],
		['鑫鑫机械制造有限公司','宏旺机械设备制造有限公司','中陶卫浴制造有限公司','丰隆机械制造有限公司','金义铸造有限公司'],
		['鸿顺建材有限公司','砼业建筑材料有限公司','丰隆机械制造有限公司','银联建材有限公司','双龙建材有限公司'],
		['玖发煤炭销售有限公司','宏图煤炭有限公司','东方石灰厂','宏林煤炭有限公司','兴达采石厂']
	];
	var datalist=[
		[30,62,74,86,99],
		[10,32,54,86,98],
	...
	function chart3() {
        ...
        var option = {
    	  	tooltip : {
				...
				formatter: function(params) {
					//			            console.log(params);
					return '<span style="color:#008ef2;font-weight:bold; font-size:16px">' + params.name + '</span>' + '<br/>' +
						'<span style="color:#666;">' + '税收收入' + ' : </span>' + '<span style="color:#ff9100;font-weight:bold;">' + params.value + '</span>' + '<br/>'
		...
		var option = {
		    ...
		    tooltip: {
		        trigger: 'axis',
		            ...
		            formatter: function (params){
//		                console.log(params);
		                return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+name+'-'+ params[0].name +'</span>' + '<br/>'
		                       + '<span style="color:#666;">'+params[0].seriesName + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;font-size:16px">'+ params[0].value +'</span>'+'<br/>'
