...
//	            console.log(params);
	            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
	                  + '<span style="color:#666;">'+params[0].seriesName + ' : </span>' +'<span style="color:#73ddf4;font-weight:bold;">'+ params[0].value +'</span>'+ '<br/>'
	                  + '<span style="color:#666;">'+params[1].seriesName + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;">'+params[1].value+'</span>'+ '<br/>'
...
function incomeType(){
	...
	var data = [
	       [randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData()],
	       [randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData(),randomData()]
	    ];
	var startBar=[],lineBar=[];  
		...
		tooltip : {
	        ...
	        formatter: function (params){
	            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
	                   + '<span style="color:#666;">'+params[0].seriesName + ' : </span>' +'<span style="color:#73ddf4;font-weight:bold;">'+ params[0].value +'</span>'+ '<br/>'
	                   + '<span style="color:#666;">'+params[1].seriesName + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;">'+params[1].value+'</span>'+ '<br/>'
	                   + '<span style="color:#666;">'+params[3].seriesName + ' : ' + (params[0].value - params[1].value > 0 ? '-' : '+') + params[3].value +'</span>'+ '<br/>'
	        },
	        padding: 10
	    },
	   	legend:{
