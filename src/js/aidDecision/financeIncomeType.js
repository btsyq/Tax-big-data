	        ...
	        //   {
	            //   if(params[i]!==null){
	                //   var v=params[i].value?params[i].value:0;
	                  ...
	                  +'<span style="color:#666;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp('+params.percent+'%)</span>'+'<br/>'
	    ...
	    tooltip: {
	        ...
	        formatter: function (params){
	            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
	                   + '<span style="color:#666;">'+params[0].seriesName + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;font-size:16px">'+ params[0].value +'</span>'+'<span style="color:#666;"> 个</span>'+'<br/>'
...
function xxCount(){
    ...
    var option = {
	    ...
	    tooltip : {
	        ...
	        formatter: function (params){
	            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
	                   + '<span style="color:#666;">'+'企业数量' + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;font-size:16px">'+ params[0].value +'</span>'+'<span style="color:#666;"> 个</span>'+'<br/>'
