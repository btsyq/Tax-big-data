		        ...
		        formatter: function (params){
		           // console.log(params);
		            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
		                  + '<span style="color:#666;">'+params[0].seriesName + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;">'+ params[0].value +'</span>'+ '<br/>'
		                  + '<span style="color:#666;">'+params[1].seriesName + ' : </span>' +'<span style="color:#10aefa;font-weight:bold;">'+params[1].value+'</span>'+ '<br/>'
		                  + '<span style="color:#666;">'+params[2].seriesName + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;">'+params[2].value+'</span>'+ '<br/>'
