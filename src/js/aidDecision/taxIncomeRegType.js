...
$(function(){
	changeNavTo("辅助决策","税收收入分析","分注册类型统计");
...
//柱图数据
	...
	var yNameArr=[
		...
		['宏旺机械设备制造有限公司','宏旺机械设备制造有限公司','中陶卫浴制造有限公司','丰隆机械制造有限公司','宏林煤炭有限公司'],
		['鸿顺建材有限公司','砼业建筑材料有限公司','丰隆机械制造有限公司','银联建材有限公司','双龙建材有限公司'],
		['中陶卫浴制造有限公司','兴达丝绸有限责任公司','丰隆机械制造有限公司','银联建材有限公司','联达机客车配件有限公司'],
	];
	var dataBar=[];
	function changedata(){
		for(var i=0;i<5;i++){
...
//		            console.log(params);
		    ...
		    legend: {
		        //orient: 'vertical',
		        x: 'center',
		        data:['增值税','营销广告','企业所得税','个人所得税','资源税',
		              '城市维护建设税','房产税','印花税','城镇土地使用税','土地增值税',
		              '车船使用税','车辆购置税','耕地占用税','契税','烟叶税','环保税'],
		        show:false
		    },
		    ...
		    series: [
		        {
		            ...
		            data:[
		                {value:data0[0], name:'内资'},
		                {value:data0[1], name:'外资'},
		                {value:data0[2], name:'港澳台资'}
		            ]
		        },
		        {
		            name:'税收收入',
		            ...
		            radius: ['40%', '55%'],
		            data:[
		                {value:data1[0], name:'增值税'},
		                {value:data1[1], name:'企业增值税'},
		                {value:data1[2], name:'个人所得税'},
		                {value:data1[3], name:'其他'},
		                {value:data1[4], name:'资源税'},
		                {value:data1[5], name:'城市维护建设税'},
		...
		myChart1.on('click', function (params) {
			console.log(params);
			if(params.seriesIndex=="0"&&params.name=="内资"){
				
				id=1;
				changedata();
				chart2(id);
			}else if(params.seriesIndex=="0"&&params.name=="港澳台资"){
				id=4;
				changedata();
				chart2(id);
			}else if(params.seriesIndex=="0"&&params.name=="外资"){
				id=5;
				changedata();
				chart2(id);
			}
...
//柱图数据
	...
	var yNameArr=[
		...
		['鑫鑫机械制造有限公司','宏旺机械设备制造有限公司','中陶卫浴制造有限公司','丰隆机械制造有限公司','金义铸造有限公司'],
		['鸿顺建材有限公司','砼业建筑材料有限公司','丰隆机械制造有限公司','银联建材有限公司','双龙建材有限公司'],
		['中陶卫浴制造有限公司','兴达丝绸有限责任公司','丰隆机械制造有限公司','银联建材有限公司','宏旺机械设备制造有限公司'],
		['玖发煤炭销售有限公司','宏图煤炭有限公司','东方石灰厂','宏林煤炭有限公司','兴达采石厂'],
	];
	var dataBar=[];
	function changedata(){
		    ...
		    series : [
		        {
		            ...
		            data:[
		                {value:data2[0], name:'税务机关A'},
		                {value:data2[1], name:'税务机关B'},
		                {value:data2[2], name:'税务机关C'},
		                {value:data2[3], name:'税务机关D'},
		                {value:data2[4], name:'其它'},
		            ]
		        }
		    ]
		}
