    ...
    var option = {
		    ...
		    tooltip : {
		        ...
		        formatter: function (params) {
		            ...
		            return params[2].name + '<br/>' + params[2].seriesName + ' : ' + params[2].value
		                    + '<br/>' + params[3].seriesName + ' : ' + params[3].value;
		        }
		    },
		    legend: {
		    	top: 20,
		    ...
		    tooltip: {
		        ...
		        formatter: function (params){
		            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
		                   + '<span style="color:#666;">'+params[0].seriesName + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;font-size:16px">'+ params[0].value +'</span>'+'<span style="color:#666;"> 万元</span>'+'<br/>'
