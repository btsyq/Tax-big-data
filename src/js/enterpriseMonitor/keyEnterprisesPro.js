		            ...
		            formatter: function (params, ticket, callback) {
		              ...
		              if (!params) {
		                  return "暂无数据"
		                      ...
		                      +'<span style="font-size:14px;color:'+params[2].color+'; font-weight:bold;">'+params[0].value+'</span>'+'<br/>'
		                      +'<span style="color:#666;font-size:12px;">'+params[1].seriesName+'&nbsp:&nbsp&nbsp'+'</span>'
		                      +'<span style="color:'+params[2].color+';font-size:14px; font-weight:bold;">'+params[1].value/10+'%</span>'+'<br/>'
		                      +'<span style="color:#666;font-size:12px;">'+params[2].seriesName+'&nbsp:&nbsp&nbsp'+'</span>'
		                      +'<span style="color:'+params[2].color+';font-size:14px; font-weight:bold;">'+params[2].value/10+'%</span>'+'<br/>'
		                return str;
	    ...
	    tooltip : {
	        ...
	        formatter: function (params, ticket, callback) {
	          ...
	          if(params.name!='invisible'){
	                  ...
	                  '&nbsp:&nbsp&nbsp'+'</span>'
	                  +'<span style="font-size:14px;color:'+params.color+'; font-weight:bold;">'+params.value+'</span>'+'<span style="color:#666;"> </span>'+'<br/>'
