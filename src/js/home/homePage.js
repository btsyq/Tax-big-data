				    ...
				    tooltip: {
				        ...
				        formatter: function (params){
				            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
				                   + '<span style="color:#666;">'+'税额' + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;font-size:16px">'+ params[0].value +'</span>'+'<span style="color:#666;"> 万元</span>'+'<br/>'
				                   + '<span style="color:#666;">'+'数量' + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;font-size:16px">'+ params[1].value +'</span>'+'<span style="color:#666;"> 个</span>'
...
function chart3(){
    ...
    var option = {
	    ...
	    tooltip : {
	        ...
	        formatter: function (params){
	            return '<span style="color:#008ef2;font-weight:bold; font-size:16px">'+ params[0].name +'</span>' + '<br/>'
	                   + '<span style="color:#666;">'+'资金' + ' : </span>' +'<span style="color:#ff9100;font-weight:bold;font-size:16px">'+ params[0].value +'</span>'+'<span style="color:#666;"> 万元</span>'+'<br/>'
